...
class WooCommerceProducts extends Form
{
  
  public $id = 'products';
  
  public $products; // List of all WooCommerce Orders
  ...
  public function fields()
  {
    ...
    $class_files = Tools::files_in_folder( __DIR__ . '/WooCommerceProductField/' );
    foreach ( $class_files as $class_file )
    {
      $klass = basename( $class_file );
      $klass = str_replace( ".php", "", $klass );
      $klass = "\\Export2Pdf\\WooCommerceProductField_" . $klass;
      $fields[] = new $klass();
    }
    ...
    usort( $fields, function ( $a, $b ) {
      ...
      if ( $a->group != $b->group )
      {
        ...
        $group_order = WooCommerceProductField::$groups;
  ...
  public function entries()
  {
    ...
    {
      $product       = new WooCommerceProduct( $product_post->ID );
      $product->form = $this;
      $products[]    = $product;
    }
